    ...
    <main className="min-h-screen bg-gray-50 p-8">
      <div className="max-w-4xl mx-auto">
        <div className="mb-8">
          ...
          <p className="text-gray-500 mt-1">Paste clinical notes → get CDT codes and claim summary instantly.</p>
        </div>
        ...
        <div className="grid grid-cols-1 lg:grid-cols-2 gap-6">
          ...
          <div className="bg-white rounded-xl shadow-sm border border-gray-200 p-6 flex flex-col gap-4">
            ...
            <textarea
              className="w-full h-80 border border-gray-200 rounded-lg p-3 text-sm font-mono resize-none focus:outline-none focus:ring-2 focus:ring-blue-500 text-black"
          ...
          <div className="bg-white rounded-xl shadow-sm border border-gray-200 p-6 flex flex-col gap-4">
            ...
            {!claim && !loading && (
              <div className="flex-1 flex items-center justify-center text-gray-400 text-sm h-80">
                Claim details will appear here.
              </div>
            )}

            {loading && (
              <div className="flex-1 flex items-center justify-center text-gray-400 text-sm h-80 animate-pulse">
                Analyzing notes...
              </div>
            )}

            {claim && (
              <div className="text-sm space-y-4 overflow-y-auto max-h-96">
